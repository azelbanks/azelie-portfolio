...
const getSkillCategories = (mode: 'strategist' | 'tech'): SkillCategory[] => {
  if (mode === 'strategist') {
    ...
    return [
      {
        id: 'ia-ml',
        name: 'IA Agentique & Machine Learning',
        icon: Brain,
        description: 'Intelligence artificielle, agents, ML et traitement du langage',
        skills: [
          { name: 'Agents IA / Orchestration', level: 'operationnel', details: 'Systèmes multi-agents (15 agents)' },
          ...
          { name: 'NLP', level: 'operationnel', details: 'spaCy, Keras, classification (89%)' },
      ...
      },
      {
        ...
        icon: Database,
        description: 'Traitement, analyse et visualisation de données',
        skills: [
          { name: 'Python', level: 'avance', details: 'Pandas, NumPy, scripts ETL' },
          { name: 'SQL', level: 'operationnel', details: 'PostgreSQL, extractions analytiques' },
          { name: 'Power BI', level: 'avance', details: 'Dashboards, modèles, DAX' },
          { name: 'Data Cleaning & Wrangling', level: 'avance', details: 'Pipelines de nettoyage' },
          { name: 'ETL', level: 'operationnel', details: 'Extraction, transformation, chargement' },
          { name: 'MongoDB', level: 'operationnel', details: 'NoSQL, pipelines temps réel' },
          { name: 'Visualisation', level: 'avance', details: 'Plotly, Streamlit, Power BI' },
      ...
      },
      {
        ...
        icon: Code,
        description: 'Langages, frameworks et infrastructure',
        skills: [
          { name: 'Streamlit', level: 'avance', details: 'Apps interactives data' },
          { name: 'Next.js / React / TypeScript', level: 'operationnel', details: 'Frontend & déploiement Vercel' },
          { name: 'HTML / CSS / Tailwind', level: 'operationnel', details: 'Interfaces web' },
          ...
          { name: 'Terminal / Bash', level: 'operationnel', details: 'Scripts, automatisation' },
          { name: 'Environnements virtuels', level: 'operationnel', details: 'venv, conda' },
        ]
      },
      {
        id: 'outils-productivite',
        name: 'Outils & Productivité',
        icon: Globe,
        description: 'Outils IA, automatisation et méthodes',
        skills: [
          ...
          { name: 'Office 365 / SharePoint', level: 'avance', details: 'Excel, Teams, collaboration' },
